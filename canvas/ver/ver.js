(function() {
	...
	class CanvasLayer extends HTMLElement {
		constructor() {
			...
			el += `<div class="slot" style="width:100%; height:100%; overflow: auto; grid-area:1/1/1/1; align-self:${this.getAttribute('align-slot')||'center'}; justify-self:${this.getAttribute('justify-slot')||'center'};"><slot></slot></div>`;
